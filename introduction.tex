...
Colliders can be circular (synchrotrons) or linear (linacs) and most commonly use either electron or proton beams (and their associated anti-particles). S%ome colliders also use more exotic beams, consisting of lead ions or other nuclei, for example. 

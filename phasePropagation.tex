...
\begin{figure}
  ...
  \caption{Typical initial mean phase jitter upstream (blue) and downstream (red) during early PFF tests.}
...
\begin{figure}
  ...
  \caption{Downstream phase vs. strength (power supply current) of the last two dipoles in TL1 (CT.0670 and CT.0710).}
  \label{f:tl1670}
\end{figure}

...
\begin{figure}
  ...
  \caption{Phase shift between the upstream and downstream phase monitors for all sets of TL1 optics when both \(R_{56}\) and \(T_{566}\) are considered.}

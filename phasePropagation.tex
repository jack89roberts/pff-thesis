...
\afterpage{\begin{landscape}
	\begin{figure}
  		\centering
  		\includegraphics[height=0.85\textwidth]{Figures/propagation/TL1}
  		\caption{Layout of dipoles (labels starting with BH), quadrupoles (labels starting with QF or QD), BPMs (labels starting with BPM or BPI), correctors (labels starting with DH or DV) and other devices in the TL1 transfer line \cite{tl1Layout}.}
  		\label{f:tl1Layout}
	\end{figure}
\end{landscape}}

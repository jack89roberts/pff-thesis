...
\begin{figure}
  ...
  \caption{Mon~1 (blue) and Mon~2 (red) diode dependence on the horizontal position during the scan. Error bars show the standard error on the measured phase values at each position (errors on the position are smaller than the markers).}
...
\begin{figure}
  ...
  \caption{Fit (black line) to the measured difference between the Mon~1 and Mon~2 phase (blue markers and standard error bars) versus the horizontal position.}
  \label{f:horizontalScanFit}
  \includegraphics[width=0.85\textwidth]{Figures/phaseMons/verticalScanFit}
  \caption{Fit (black line) to the measured difference between the Mon~1 and Mon~2 phase (blue markers and standard error bars) versus the vertical position.}

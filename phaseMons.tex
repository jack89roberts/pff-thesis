...
\begin{table}
  \begin{center}
    ...
    \end{tabular}
    \caption{Initial estimates and final fitted values for the four sinusoidal fit parameters for a distirubtion generated with \(A = b = c = d = 1\) (plus random noise).}
  	\label{t:sinFitEx}
  \end{center}
\end{table}
...
\begin{figure}
  ...
  \caption{Best achieved phase monitor resolution meausred point by point along the pulse (sampled at 192~MHz on the SiS digitisers).}
...
\begin{figure}
  ...
  \caption{Difference between Mon~1 and Mon~2 phase along the pulse with (red) and without (blue) Mon~2 rotated.}
